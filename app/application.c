...
void temperature_tag_event_handler(bc_tag_temperature_t *self, bc_tag_temperature_event_t event)
{
    (void) event;
...
void barometer_tag_event_handler(bc_tag_barometer_t *self, bc_tag_barometer_event_t event)
{
    (void) event;
...
void application_init(void)
{
    ...
    bc_tag_lux_meter_set_event_handler(&lux_meter, lux_meter_event_handler);
    ...
    bc_tag_barometer_set_event_handler(&barometer_tag, barometer_tag_event_handler);

    static bc_lis2dh12_t lis2dh12;

    bc_lis2dh12_init(&lis2dh12, BC_I2C_I2C0, BC_LIS2DH12_ADDRESS_ALTERNATE);
    bc_lis2dh12_set_update_interval(&lis2dh12, 100);
    bc_lis2dh12_set_event_handler(&lis2dh12, lis2dh12_event_handler);
